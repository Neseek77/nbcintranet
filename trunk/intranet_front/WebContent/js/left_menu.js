...
$("#slide .sub").click(function() {
	if (this.className.indexOf('clicked') != -1 ) {
		...
		$(this)			.removeClass('clicked')
						.css("background", "#eee url(out.gif) no-repeat 5px 8px")
						.css("color", "#000");
		}
		else {
		animate(sY);
...
$(this)					.css("background", "#ddd url(down.gif) no-repeat 5px 8px")
						.css("color", "#c00");
},function(){
if (this.className.indexOf('clicked') == -1) {
$(this)					.css("background", "#eee url(out.gif) no-repeat 5px 8px")
						.css("color", "#000");
}
});
